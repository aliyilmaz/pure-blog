    ...
    <div class="content pure-u-1 pure-u-md-3-4">
        <div>
            ...
            <div class="posts">
                ...
                <section class="post">
                    <header class="post-header">
                        <img width="48" height="48" alt="Eric Ferraiuolo&#x27;s avatar" class="post-avatar" src="public/img/common/ericf-avatar.png">
                ...
                <section class="post">
                    <header class="post-header">
                        <img width="48" height="48" alt="Reid Burke&#x27;s avatar" class="post-avatar" src="public/img/common/reid-avatar.png">
                ...
                <section class="post">
                    <header class="post-header">
                        <img width="48" height="48" alt="Andrew Wooldridge&#x27;s avatar" class="post-avatar" src="public/img/common/andrew-avatar.png">
